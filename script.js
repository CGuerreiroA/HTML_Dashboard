...
const emissionsData = {
    ...
    trend: {
        labels: ['2025-1', '2024-9', '2024-10', '2024-7', '2024-4', '2024-12', '2024-6', '2024-11'],
        values: [162, 32, 13, 12, 11, 9, 6, 0],
        target: 250,
        forecast: [162, 155, 148, 142, 135, 130]
    }
};
...
if (trendCtx) {
    new Chart(trendCtx, {
        type: 'line',
        data: {
            labels: emissionsData.trend.labels,
            datasets: [
                {
                    label: 'Actual Emissions',
                    data: emissionsData.trend.values,
                    borderColor: '#3498db',
                ...
                {
                    label: 'Target',
                    data: Array(emissionsData.trend.labels.length).fill(emissionsData.trend.target),
                    borderColor: '#95a5a6',
                    borderWidth: 2,
                    borderDash: [10, 5],
                    fill: false,
                ...
                },
                {
                    ...
                    data: [
                        ...
                        emissionsData.trend.values[emissionsData.trend.values.length - 1],
                        ...emissionsData.trend.forecast
                    ],
                    borderColor: '#95a5a6',
